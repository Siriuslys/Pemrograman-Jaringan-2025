...
class FileInterface:
    ...
    def upload(self, params=[]):
        try:
            if len(params) < 2:
                return dict(status='ERROR', data='Parameter tidak lengkap: butuh nama file dan konten base64')
    ...
    def delete(self, params=[]):
        try:
            if len(params) < 1:
                return dict(status='ERROR', data='Parameter tidak lengkap: butuh nama file')
