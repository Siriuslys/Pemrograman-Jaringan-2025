...
class StressTestClient:
    ...
    def _ensure_directories(self):
        for directory in ['test_files', 'downloads']:
    ...
    def send_command(self, command_str=""):
        ...
        try:
            ...
            return {'status': 'ERROR', 'data': f'JSON decode error: {str(e)}'}
...
if __name__ == "__main__":
    ...
    operations = ['list', 'download', 'upload'] if args.operation == 'all' else [args.operation]
